...
if __name__ == "__main__":
    ...
    for project_id in project_ids:
        ...
        for index, row in df.iterrows():
          ...
          response = my_api_helper.post_as_diagram_with_external_geometries(flat_geobuf_url=flat_geobuf_url,projectorpolicy=project_or_policy, featuretype= feature_type,description= description, fundingtype=funding_type, sysid= system_id)
          print(response.json())
